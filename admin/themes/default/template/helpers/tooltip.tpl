...
<span class="tooltip-trigger{if isset($tooltip_class) && $tooltip_class} {$tooltip_class|escape:'html':'UTF-8'}{/if}">
	{if isset($tooltip_trigger_html) && $tooltip_trigger_html}
		{$tooltip_trigger_html nofilter}
	{elseif isset($tooltip_title) && $tooltip_title}
		<span class="badge badge-primary">
		{if isset($tooltip_icon_class) && $tooltip_icon_class}
		...
		{/if}
		{$tooltip_title|escape:'html':'UTF-8'}</span>
