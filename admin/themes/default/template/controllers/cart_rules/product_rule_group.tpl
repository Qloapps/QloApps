<tr id="product_rule_group_{$product_rule_group_id|intval}_tr">
	...
	<td>
		...
		<div class="form-group">
			...
			<div class="col-lg-7">
				<label  class="control-label pull-left">{l s='Stay type(s) matching the following rules:'}</label>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-4">
				<select class="form-control" id="product_rule_type_{$product_rule_group_id|intval}">
					...
					<option value="products">{l s='Stay Types'}</option>
		...
		{l s='The Stay Type(s) are matching one of these:'}
