                                        ...
                                        <table class="table table-responsive">
                                            <tbody>
                                                ...
                                                {if isset($fixed_tax_breakdown) && $fixed_tax_breakdown|@count > 0}
                                                    ...
                                                    <tr class="total_fixed_tax_row">
                                                        <td class="text-left">{$taxName|escape:'html':'UTF-8'}</td>
                                                        <td class="amount text-right nowrap">
                                                            {displayPrice price=$taxData.total_amount currency=$currency->id}
                                                        </td>
                                                        <td class="partial_refund_fields current-edit" style="display:none;"></td>
                                                    </tr>
                                                    {/foreach}
                                                {elseif isset($fixed_tax) && $fixed_tax > 0}
