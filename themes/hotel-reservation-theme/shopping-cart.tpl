...
{block name='shopping_cart_content'}
	...
	{block name='shopping_cart_order_steps_container'}
	...
	{else}
		...
		{* eu-legal *}
		{block name='hook_display_before_shopping_cart_block'}
			...
			<div class="order-detail-content">
				{if isset($cart_htl_data) && $cart_htl_data}
					...
					{foreach from=$cart_htl_data key=data_k item=data_v}
						{block name='order_detail_room_type_list'}
							{foreach from=$data_v['date_diff'] key=rm_k item=rm_v}
								<div class="row cart_product_line">
									{block name='shopping_cart_room_image'}
										...
										<div class="col-sm-2 product-img-block">
											...
											{block name='hook_display_cart_room_image_after'}
												{hook h='displayCartRoomImageAfter' id_product=$data_v['id_product']}
											{/block}
										</div>
									{/block}
									<div class="col-sm-10">
										{block name='shopping_cart_room_type_info'}
											<div class="room-info-container">
												...
												<div class="product-xs-info">
													...
													{/if}
													{block name='hook_display_cart_room_type_info'}
										...
										{/block}
										{block name='hook_display_cart_product_content_after'}
				...
				{if isset($cart_normal_data) && $cart_normal_data}
					...
					{block name='shopping_cart_ normal_product_list'}
