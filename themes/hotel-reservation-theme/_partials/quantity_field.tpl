...
<div class="rm_qty_cont form-group clearfix">
    ...
    <div class="qty_direction qlo-stepper">
        <a href="#" data-field-qty="qty" class="btn btn-default quantity_up rm_quantity_up qlo-stepper__btn">
            <span><i class="icon-plus"></i></span>
        </a>
        <a href="#" data-field-qty="qty" class="btn btn-default quantity_down rm_quantity_down qlo-stepper__btn">
