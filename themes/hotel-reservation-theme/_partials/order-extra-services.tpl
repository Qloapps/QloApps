...
{block name='booking_demands'}
    <div class="card">
        {block name='booking_demands_header'}
            <div class="card-header">
                {l s='Extra Services'}
            </div>
        {/block}
        {block name='booking_demand_tabs'}
            <div class="card-body">
                {if (isset($extraDemands) && $extraDemands) || (isset($additionalServices) && $additionalServices)}
                    <div class="">
                        ...
                        <div class="tab-content">
                            {block name='booking_demand_tab_content'}
                                {if isset($extraDemands) && $extraDemands}
                            ...
                            {block name='booking_service_tab_content'}
                                {if isset($additionalServices) && $additionalServices}
