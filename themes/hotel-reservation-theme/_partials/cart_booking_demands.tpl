			...
			{block name='cart_booking_demands_tabs'}
				<ul class="nav nav-tabs">
					{if isset($selectedRoomDemands) && $selectedRoomDemands}
						<li><a href="#room_type_demands_desc" data-toggle="tab" class="active">{l s='Facilities'}</a></li>
					{/if}
					{if isset($roomTypeServiceProducts) && $roomTypeServiceProducts}
						<li><a href="#room_type_service_product_desc" data-toggle="tab" {if !isset($selectedRoomDemands) || !$selectedRoomDemands} class="active"{/if}>{l s='Services'}</a></li>
					{/if}
				</ul>
			{/block}
					...
					{block name='cart_booking_demands_tab_content'}
						{if isset($selectedRoomDemands) && $selectedRoomDemands}
							<div id="room_type_demands_desc" class="tab-pane active">
								<div class="rooms_extra_demands_head h10">
									<p class="rooms_extra_demands_text mb-0">{l s='Add below facilities to the rooms for better hotel experience'}</p>
								</div>
								<hr class="separator">
								...
								{foreach $selectedRoomDemands as $key => $roomDemand}
									<div>
										<div class="row accordion-section">
											<div class="col-sm-12 demand_header mb-3">
														...
														<div class="row room_demand_block">
															<div class="col-8">
																<div class="row">
																	...
																	<div class="col-10 demand_adv_option_block">
					...
					{block name='cart_booking_services_tab_content'}
						{if isset($roomTypeServiceProducts) && $roomTypeServiceProducts}
							<div id="room_type_service_product_desc" class="tab-pane{if !isset($selectedRoomDemands) || !$selectedRoomDemands} active{/if}">
								<div class="rooms_extra_demands_head h10">
									<p class="rooms_extra_demands_text mb-0">{l s='Add below services to the rooms for better hotel experience'}</p>
								</div>
								<hr class="separator">
								{assign var=roomCount value=1}
														...
														<div class="row room_demand_block">
															<div class="col-8">
																<div class="row">
																	...
																	<div class="col-10">
																		<p class="mb-1">{$product['name']|escape:'html':'UTF-8'}</p>
																		{if $product.allow_multiple_quantity}
																			<div class="qty_container mb-2">
