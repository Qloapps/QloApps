												...
												{if isset($roomTypeServiceProducts) && $roomTypeServiceProducts}
													{foreach $roomTypeServiceProducts as $product}
														<div class="row room_demand_block">
															<div class="col-xs-8">
																<div class="row">
																	{block name='extra_service_select_field'}
																		<div class="col-xs-2">
																	...
																	{/block}
																	{block name='extra_service_information'}
																		<div class="col-xs-10">
																			{block name='extra_service_name'}
																				<p>{$product['name']|escape:'html':'UTF-8'}</p>
																			{/block}
																			{if $product.allow_multiple_quantity}
																				{block name='extra_service_quantity_actions'}
																					<div class="qty_container">
																						{block name='extra_service_quantity_field'}
																						...
																						<div class="qty_controls">
																							{block name='extra_service_quantity_action_up'}
																								<a href="#" class="qty_up"><span><i class="icon-plus"></i></span></a>
																							{/block}
																							{block name='extra_service_quantity_action_down'}
