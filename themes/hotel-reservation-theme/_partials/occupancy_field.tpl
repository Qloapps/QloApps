...
{block name='occupancy_fields_content'}
    <div class="form-group dropdown">
        {block name='booking_occupancy'}
        ...
        {block name='booking_occupancy_fields'}
            <div class="dropdown-menu booking_occupancy_wrapper">
                {block name='booking_occupancy_hidden_fields'}
                ...
                {/block}
                {block name='occupancy_fields_booking_occupancy_inner'}
                    <div class="booking_occupancy_inner">
                        {if isset($occupancies) && $occupancies}
                            ...
                            {foreach from=$occupancies key=key item=$occupancy name=occupancyInfo}
                                {block name='occupancy_info_block'}
                ...
                {/block}
                {block name='booking_occupancy_actions'}
