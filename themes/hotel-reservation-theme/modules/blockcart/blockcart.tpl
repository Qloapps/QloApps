...
{block name='block_cart_content'}
	...
	{block name='block_cart_shopping_cart'}
		...
		{/if}
			<div class="shopping_cart">
				...
				{block name='block_cart_cart_block'}
					{if !$PS_CATALOG_MODE}
	...
	{block name='block_cart_layer_cart'}
		...
		{if !$PS_CATALOG_MODE && $active_overlay == 1}
			<div id="layer_cart">
				<div class="clearfix">
					{block name='block_cart_layer_cart_product'}
					...
					{/block}
					{block name='block_cart_layer_cart_cart'}
