...
{/if}
	...
	{else}
	    <li class="active"><a class="user_login navigation-link" href="{$link->getPageLink('my-account', true)|escape:'html'}" rel="nofollow" title="{l s='Log in to your customer account' mod='blockuserinfo'}"><span class="hide_xs">{l s='Sign in' mod='blockuserinfo'}</span><span class="visi_xs"><i class="icon-user"></i></span></a></li>
	{/if}
	</ul>
{if !isset($ajaxCustomerLogin)}
</div>
