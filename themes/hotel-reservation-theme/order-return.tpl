...
{block name='order_return_content'}
	{capture name=path}
	...
	{block name='order_return_errors_container'}
		{include file="./errors.tpl"}
	{/block}
	{block name='order_return_container'}
		<div class="panel card">
			<h1 class="page-heading bottom-indent">
				<i class="icon-tasks"></i> &nbsp;{l s='Booking Refund Requests'}
			</h1>
			<div class="table-responsive wk-datatable-wrapper">
				{block name='order_return_booking_detail_table'}
					<table class="table table-bordered">
						{block name='order_return_booking_detail_table_head'}
							<tr>
								<th>{l s='Rooms'}</th>
								<th>{l s='Room type'}</th>
								<th>{l s='Hotel'}</th>
						...
						{/block}
						{block name='order_return_booking_detail_table_body'}
