...
<div class="container-md">
	<nav>
		<ol class="breadcrumb clearfix">
			<li class="breadcrumb-item"><a class="home" href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}" title="{l s='Return to Home'}"><i class="icon-home"></i></a></li>
