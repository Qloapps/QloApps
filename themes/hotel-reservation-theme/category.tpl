                ...
                <div class="row margin-lr-0 catSortBlock">
                    ...
                    <div class="col-sm-3">
                        <div class="filter_dw_cont">
                            <button class="qlo-dropdown-trigger dropdown-toggle" type="button" id="price_ftr" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="sort_btn_span" data-sort-by="0" data-sort-value="0" data-sort-for="{l s='Recommended'}">{l s='Recommended'}</span>
