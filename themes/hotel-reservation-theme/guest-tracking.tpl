						...
						<div class="card transform-account">
							...
							<div class="card-body">
								<form method="post" action="{$action|escape:'html':'UTF-8'}#guestToCustomer" class="std">
									...
									<button type="submit" name="submitTransformGuestToCustomer" class="button btn-medium btn btn-submit">
										<span>{l s='Send'}</span>
									</button>
								</form>
							</div>
			...
			<form method="post" action="{$action|escape:'html':'UTF-8'}" class="std" id="guestTracking">
				<fieldset class="description_box box">
					...
					{block name='guest_tracking_submit'}
						<p>
							<button type="submit" name="submitGuestTracking" class="button btn btn-default btn-medium"><span>{l s='Send'}<i class="icon-chevron-right right"></i></span></button>
						</p>
					{/block}
				</fieldset>
			</form>
