...
{block name='order_confirmation_content'}
	...
	{block name='order_confirmation_errors_container'}
	...
	<div class="box">
		{block name='hook_payment_return'}
			{$HOOK_PAYMENT_RETURN}
		{/block}
		{block name='order_confirmation_details'}
			{if isset($order->id) && $order->id}
				{if $is_guest}
					{block name='order_confirmation_guest_booking_details'}
				...
				{else}
					...
					<div id="order-detail-content" class="">
						{block name='order_confirmation_detail_table'}
							<table class="table table-bordered">
								{if isset($cart_htl_data)}
									{block name='order_confirmation_detail_table_head'}
										<thead>
											<tr>
									...
									{/block}
									{block name='order_confirmation_detail_table_body'}
										<tbody>
									...
									{/block}
								{/if}
								{block name='order_confirmation_service_detail_table'}
									...
									{/if}
								{/block}
								{block name='order_confirmation_price_details'}
									<tfoot>
										{if isset($cart_htl_data)}
