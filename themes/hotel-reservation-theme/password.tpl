...
<form action="{$request_uri|escape:'html':'UTF-8'}" method="post" class="std" id="form_forgotpassword">
	<fieldset>
		...
		<p class="submit">
            <button type="submit" class="btn htl-reservation-form-btn-default"><span>{l s='Retrieve Password'}&nbsp;<i class="icon-chevron-right right"></i></span></button>
		</p>
	</fieldset>
</form>
{/if}
...
<ul class="clearfix footer_links">
	<li><a class="btn btn-default htl-reservation-form-btn-small" href="{$link->getPageLink('authentication')|escape:'html':'UTF-8'}" title="{l s='Back to Login'}" rel="nofollow"><span><i class="icon-chevron-left"></i>&nbsp;{l s='Back to Login'}</span></a></li>
</ul>
