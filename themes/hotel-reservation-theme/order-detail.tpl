        ...
        <div class="col-md-8">
            ...
            <div class="card hotel-location visible-xs visible-sm hidden-md hidden-lg">
                ...
                <div class="card-body">
                    ...
                    {if ($obj_hotel_branch_information->latitude|floatval != 0 && $obj_hotel_branch_information->longitude|floatval != 0) && $view_on_google_map}
        ...
        <div class="col-md-4">
            ...
            <div class="card hotel-location hidden-xs hidden-sm visible-md">
                ...
                <div class="card-body">
                    ...
                    {if ($obj_hotel_branch_information->latitude|floatval != 0 && $obj_hotel_branch_information->longitude|floatval != 0) && $view_google_map}
                        <div class="hotel-location-map">
                            <div class="booking-hotel-map-container"></div>
                        </div>
                    {/if}
