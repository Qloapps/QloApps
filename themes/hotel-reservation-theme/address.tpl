...
*}
{block name='address_page'}
	{block name='address_page_breadcrumbs'}
		{capture name=path}
		...
		{/capture}
	{/block}
	{block name='address_page_update_message'}
		...
		{/if}
	{/block}
	{block name='address_page_box'}
		<div class="box">
			{block name='address_page_subheading'}
				<h1 class="page-subheading">{l s='Address'}</h1>
			{/block}
			{block name='address_page_subheading_description'}
				<p class="info-title">
				...
				<form action="{$link->getPageLink('address', true)|escape:'html':'UTF-8'}" method="post" class="std" id="add_address">
					...
					{block name='address_form_fields'}
						...
						<div class="required form-group" id="adress_alias">
							...
							{block name='display_gdpr_consent'}
	...
	{/block}
	{block name='address_page_footer_links'}
