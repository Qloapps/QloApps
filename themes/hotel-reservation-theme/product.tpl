...
{block name='room_type_content'}
	{block name='room_type_errors_container'}
	...
	{if $errors|@count == 0}
		...
		<div class="product_wrapper" itemscope itemtype="http://schema.org/Product">
			{if isset($product) && $product}
				...
				{block name='room_type_primary_block'}
					<div class="primary_block row">
						...
						{/if} --><!-- by webkul -->
						{block name='room_type_admin_action'}
							...
							{/if}
						{/block}
						{block name='room_type_confirmation'}
						...
						{block name='room_type_left_column'}
							...
							<div class="pb-left-column col-xs-12 col-sm-8 col-md-8">
										...
										{block name='room_type_hotel_name_block'}
											<div class="room_hotel_name_block">
												<div class="hotel_name_block">
													...
													{block name='display_room_type_detail_room_type_name_block'}
														{hook h='displayRoomTypeDetailRoomTypeNameBlock' id_product=$product->id}
													{/block}
												</div>
												{block name='display_room_type_detail_room_type_name_after'}
													{hook h='displayRoomTypeDetailRoomTypeNameAfter' id_product=$product->id}
												{/block}
											</div>
										{/block}
										{block name='display_room_type_detail_room_typeitmage_block_before'}
											...
											<div class="row">
												<div id="image-block-cont" class="col-xs-12 col-sm-9 col-sm-push-3 col-md-10 col-md-push-2">
													<div id="image-block" class="clearfix">
														...
														{/if}
														{block name='display_room_type_image_after'}
												...
												<div class="col-xs-12 col-sm-3 col-sm-pull-9 col-md-2 col-md-pull-10">
													{if isset($images) && count($images) > 0}
														<!-- thumbnails -->
															{block name='room_type_thumbs_view'}
								...
								{block name='room_type_service_products'}
									<div id="service_products_cont">
										{if isset($service_products_exists) && $service_products_exists}
											{block name='service_products_container'}
								...
								{block name='room_type_info_container'}
									<div class="product_info_containter">
										<!-- tab hook is added here -->
										<!--HOOK_PRODUCT_TAB -->
										{block name='room_type_info_tabs'}
											<section class="page-product-box">
												{block name='room_type_info_tabs_list'}
												...
												{/block}
												{block name='room_type_info_tabs_content'}
													<div class="tab-content product_description_tabs_contents">
														...
														{/block}
														{* Block for booking products *}
														{block name='room_type_info_refund_policies_tab_cont'}
															{if isset($id_hotel) && $id_hotel}
															...
															{/if}
														{/block}
														{block name='room_type_info_hotel_locaiton_tab_cont'}
															{if $display_google_maps && ($hotel_latitude|floatval != 0 && $hotel_longitude|floatval != 0)}
						...
						{block name='room_type_right_column'}
							<div class="pb-right-column col-xs-12 col-sm-4 col-md-4">
								{if ($product->show_price && !isset($restricted_country_mode)) || isset($groups) || $product->reference || (isset($HOOK_PRODUCT_ACTIONS) && $HOOK_PRODUCT_ACTIONS)}
									{block name='room_type_booking_hidden_fields'}
										<p class="hidden">
