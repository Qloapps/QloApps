                        ...
                        {block name='shopping_cart_room_type_booking_information'}
                            <div class="room_duration_block">
                                <div class="col-sm-3 col-xs-6">
                                    ...
                                    <p class="room_duration_block_value">{$rm_v['data_form']|date_format:"%d %b, %a"} {$rm_v['data_form']|date_format:"%H:%M"}</p>
                                </div>
                                <div class="col-sm-3 col-xs-6">
                                    <p class="room_duration_block_head">{l s='CHECK OUT'}</p>
                                    <p class="room_duration_block_value">{$rm_v['data_to']|date_format:"%d %b, %a"} {$rm_v['data_to']|date_format:"%H:%M"}</p>
                                </div>
