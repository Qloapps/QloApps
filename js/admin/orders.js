...
function init()
{
	...
	// function updateOccupancyInput()
	// {
    //     let roomRequired = parseInt($('input#add_product_product_quantity').val());
	// 	let add_booking_occupancy_div = $('tr#new_product').find('#add_product_occupancy');
	// 	if ($(add_booking_occupancy_div).find('> div').length < roomRequired) {
	// 		while ($(add_booking_occupancy_div).find('> div').length < roomRequired) {
	// 			let html = '<div class="row">';
	// 				html += '<div class="form-group">';
	// 					html += '<div class="fixed-width-xl adult_occupancy_div">';
	// 						html += '<div class="input-group">';
	// 							html += '<div class="input-group-addon">'+adults_txt+'</div>';
	// 							html += '<input type="number" class="form-control add_product_adults" name="add_product[adult]" value="1" min="1"/>';
	// 						html += '</div>';
	// 					html += '</div>';
	// 					html += '<br/>';
	// 					html += '<div class="fixed-width-xl children_occupancy_div">';
	// 						html += '<div class="input-group">';
	// 							html += '<div class="input-group-addon">'+children_txt+'</div>';
	// 								html += '<input type="number" class="form-control add_product_children" name="add_product[children]" value="1" min="0"/>';
	// 						html += '</div>';
	// 					html += '</div>';
	// 					html += '<br/>';
	// 					html += '<div class="fixed-width-xl children_age_div">';
	// 						html += '<label>'+child_age_txt+'</label>';
	// 						html += '<div class="child_age">';
	// 							html += '<select class="guest_child_age room_occupancies" name="add_product[child_ages][]">';
	// 								html += '<option value="-1" selected>'+select_age_txt+'</option>';
	// 								html += '<option value="0" >'+under_1_txt+'</option>';
	// 								for(age=1; age<max_child_age; age++) {
	...
	// 				html += '</div>';
	// 			html += '</div>';
	// 			$(add_booking_occupancy_div).append(html);
	// 		}
	// 	} else {
	// 		$(add_booking_occupancy_div).find('> div').each(function(ind, element) {
	// 			if (roomRequired <= ind) {
	// 				element.remove();
	// 			}
	// 		});
	...
	// $('.add_product_children').on('change', function(e) {
    //     let elementVal = parseInt($(this).val());
	// 	let children_age_div = $(this).closest('.row').find('.children_age_div');
	// 	if ($(children_age_div).find('.child_age').length < elementVal) {
	// 		while ($(children_age_div).find('.child_age').length < elementVal) {
	// 			let html = '<div class="child_age test">';
	// 				html += '<select class="guest_child_age room_occupancies" name="add_product_occupancy[child_ages][]">';
	// 					html += '<option value="-1" selected>'+select_age_txt+'</option>';
	// 					html += '<option value="0">'+under_1_txt+'</option>';
	// 					for(age=1; age<max_child_age; age++) {
	// 						html += '<option value="'+age+'">'+age+'</option>';
	...
	// 			$(children_age_div).closest('.children_age_div').append(html);
	// 			// children_age_div = $(this).closest('.booking_occupancy_edit').find('.children_age_div .child_age');
	// 		}
	// 	} else {
	// 		$(children_age_div).find('.child_age').each(function(ind, element) {
	// 			if (elementVal <= ind) {
	// 				element.remove();
	// 			}
	// 		});
