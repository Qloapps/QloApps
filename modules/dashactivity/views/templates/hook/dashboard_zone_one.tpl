        ...
        <ul class="stats-list">
            <li>
                <span class="item-label">
                    <a href="{$link->getAdminLink("AdminOrders")|escape:"html":"UTF-8"}&amp;submitFilterorder=1&amp;orderFilter_rrb!is_room_refunded=0&amp;orderFilter_amount_due%5B0%5D={$min_due_amount}" target="_blank">
