...
class QcmcCMConnectorDb
{
    ...
    public function createTables()
    {
        $sqls = array(
            ...
            "ALTER TABLE `" . _DB_PREFIX_ . "htl_booking_detail` ADD COLUMN `rate_plan_name` VARCHAR(255) DEFAULT NULL"
        );
    ...
    public function dropTables()
    {
        $sqls = array(
            ...
            "ALTER TABLE `"._DB_PREFIX_."orders` DROP COLUMN `id_channel_manager_booking`",
            "ALTER TABLE `" . _DB_PREFIX_ . "htl_booking_detail` DROP COLUMN `rate_plan_name`"
        );
