		...
		<form method="post" action="{$htmlitems.postAction|escape:'htmlall':'UTF-8'}" enctype="multipart/form-data" class="item-form defaultForm  form-horizontal">
			<div class="well">
				...
				<div class="url item-field form-group">
					<label class="control-label col-lg-3">{l s='Description Product' mod='themeconfigurator'}</label>
					<div style="width: 195px;">
						<select class="form-control" name="item_url" id="item_url">
							<option value="10">Choose Product</option>
							{foreach from=$all_products item=data}
								<option value="{$data.id_product}" selected="selected">{$data.name}</option>
							{/foreach}
						</select>
					</div>
					<!-- <div class="col-lg-7">
						<input type="text" name="item_url" placeholder="Enter heading of your description" />
					</div> -->
				</div>
				...
				<div class="item-field form-group">
					<label class="control-label col-lg-3">{l s='Description side' mod='themeconfigurator'}</label>
					<div style="width: 195px;">
						<select class="form-control" name="description_side" id="description_side">
