...
class HotelHelper
{
    const SLIDER_NAV_TYPE_DOTS = 0;
    const SLIDER_NAV_TYPE_BUTTON = 1;

    public static function getSliderNavigationTypes()
    {
        $objModule = Module::getInstanceByName('hotelreservationsystem');
        return array(
            array(
                'id' => HotelHelper::SLIDER_NAV_TYPE_DOTS,
                'name' => $objModule->l('Navigation Type Dots', true),
            ),
            array(
                'id' => HotelHelper::SLIDER_NAV_TYPE_BUTTON,
                'name' => $objModule->l('Navigation Type Buttons', true),
            ),
        );
    }
