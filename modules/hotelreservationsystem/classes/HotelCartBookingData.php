    ...
    public function getCartFormatedBookinInfoByIdCart($id_cart)
    {
        ...
        if ($cart_detail_data) {
            ...
            foreach ($cart_detail_data as $key => $value) {
                ...
                $cart_detail_data[$key]['connected_rooms'] = HotelRoomConnected::getConnectedRoomsByHotel($obj_htl_room_info->id_hotel, Context::getContext()->language->id, $obj_htl_room_info->id, true);
            }
        }
        if ($cart_detail_data) {
