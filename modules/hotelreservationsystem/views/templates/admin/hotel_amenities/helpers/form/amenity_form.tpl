	...
	<div class="panel-body">
		<form id="htl_amenity_form" class="defaultForm form-horizontal"
					...
					{foreach from=$languages item=language}
						...
						{/if}
							<input type="text"
								   ...
								   value="{if isset($amenity.name[$language.id_lang])}{$amenity.name[$language.id_lang]|escape:'htmlall':'UTF-8'}{/if}"
								   class="form-control"
								   maxlength="128" />
						{if $languages|count > 1}
							</div>
				...
				<div class="col-lg-9">
					<span class="switch prestashop-switch fixed-width-lg">
						<input type="radio" name="active" id="active_on" value="1"
							{if !isset($amenity.active) || $amenity.active}checked="checked"{/if} />
				...
				<div class="col-lg-9">
					<span class="switch prestashop-switch fixed-width-lg">
						<input type="radio" name="is_featured" id="is_featured_on" value="1"
							{if isset($amenity.is_featured) && $amenity.is_featured}checked="checked"{/if} />
			...
			<div class="form-group">
				...
				<div class="col-lg-4">
					<select name="logo_type" id="htl_logo_type_select" class="form-control">
						<option value="image"
							{if !isset($amenity.logo_type) || $amenity.logo_type != 'icon'}selected="selected"{/if}>
			...
			<div class="form-group" id="htl_logo_image_row"
				 {if isset($amenity.logo_type) && $amenity.logo_type == 'icon'}style="display:none;"{/if}>
			...
			<div class="form-group" id="htl_logo_icon_row"
				...
				<div class="col-lg-5">
					<input type="text" name="logo_icon" class="form-control"
						   value="{if isset($amenity.logo) && isset($amenity.logo_type) && $amenity.logo_type == 'icon'}{$amenity.logo|escape:'htmlall':'UTF-8'}{/if}"
