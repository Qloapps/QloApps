<div class="htl_room_data_cont">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="row">
                <div class="col-sm-12 htl_room_cat_data">
                    <p class="room_cat_header">{l s='Total Stays' mod='hotelreservationsystem'}</p>
        ...
        <div class="col-sm-6">
            <div class="row">
                <div class="col-sm-12 htl_room_cat_data">
                    <p class="room_cat_header">{l s='Available Stays' mod='hotelreservationsystem'}</p>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="row">
                <div class="col-sm-12 htl_room_cat_data">
                    <p class="room_cat_header">{l s='Booked Stays' mod='hotelreservationsystem'}</p>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="row">
                <div class="col-sm-12 htl_room_cat_data">
                    <p class="room_cat_header">{l s='Unavailable Stays' mod='hotelreservationsystem'}</p>
        ...
        <div class="col-sm-6">
            <div class="row">
                <div class="col-sm-12 htl_room_cat_data">
                    <p class="room_cat_header">{l s='In-Cart Stays' mod='hotelreservationsystem'}</p>
    ...
    <div class="row">
        <div class="col-sm-6 indi_cont clearfix">
            ...
            <span class="indi_label">{l s='Available Stays' mod='hotelreservationsystem'}</span>
        </div>
        <div class="col-sm-6 indi_cont clearfix">
        ...
        <div class="col-sm-6 indi_cont clearfix">
            ...
            <span class="indi_label">{l s='Unavailable Stays' mod='hotelreservationsystem'}</span>
        </div>
        <div class="col-sm-6 indi_cont clearfix">
            <span class="color_indicate bg-blue"></span>
            <span class="indi_label">{l s='Booked Stays' mod='hotelreservationsystem'}</span>
        </div>
    </div>
</div>