<div class="htl_room_data_cont">
    ...
    {/capture}
    {include file='helpers/tooltip.tpl' tooltip_content=$smarty.capture.status_info_tooltip_content tooltip_icon_class='icon-info-circle' tooltip_class='status-info-tooltip'}
    <div class="row">
        <div class="col-sm-6">
            <div class="row">
