								...
								{if isset($cart_bdata)}
									{foreach $cart_bdata as $cart_data}
										<tr>
											...
											<td class="text-center">{convertPrice price=($cart_data['amt_with_qty'] + $cart_data['additional_services_auto_add_with_room_price'] + $cart_data['additional_service_price'])}</td>
