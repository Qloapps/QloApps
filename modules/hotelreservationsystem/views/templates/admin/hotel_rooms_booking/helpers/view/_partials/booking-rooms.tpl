                                                            ...
                                                            <button class="btn btn-default btn-left btn-block booking_guest_occupancy input-occupancy" type="button">
                                                                <span>
                                                                    {if isset($book_v['occupancies']) && $book_v['occupancies']}
                                                                        {if (isset($book_v['occupancy_adults']) && $book_v['occupancy_adults'])}{$book_v['occupancy_adults']} {if $book_v['occupancy_adults'] > 1}{l s='Adults'}{else}{l s='Adult'}{/if}, {if isset($book_v['occupancy_children']) && $book_v['occupancy_children']}{$book_v['occupancy_children']} {if $book_v['occupancy_children'] > 1} {l s='Children'}{else}{l s='Child'}{/if}, {/if}{$book_v['occupancies']|count} {if $book_v['occupancies']|count > 1}{l s='Rooms'}{else}{l s='Room'}{/if}{else}{l s='1 Adult, 1 Room'}{/if}
                                                                    {else}
                                                                                ...
                                                                                <div class="col-sm-12">
                                                                                    <div class="row">
                                                                                        <div class="form-group col-xs-6 occupancy_count_block">
                                                                                            ...
                                                                                            <input type="number" class="form-control num_occupancy num_adults" name="occupancy[{$key|escape:'htmlall':'UTF-8'}][adults]" value="{$occupancy['adults']|escape:'htmlall':'UTF-8'}" min="1"  max="{if isset($book_v)}{$book_v['max_adults']|escape:'html':'UTF-8'}{/if}">
                                                                                        </div>
                                                                                        <div class="form-group col-xs-6 occupancy_count_block">
                                                                                            <label>{l s='Children'} <span class="label-desc-txt"></span></label>
                                                                                            <input type="number" class="form-control num_occupancy num_children" name="occupancy[{$key|escape:'htmlall':'UTF-8'}][children]" max="{}" value="{$occupancy['children']|escape:'htmlall':'UTF-8'}" min="0" max="{if isset($book_v)}{$book_v['max_children']|escape:'html':'UTF-8'}{else}{$max_child_in_room}{/if}">
