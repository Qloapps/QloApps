...
<tr class="qlo-img-row" id="qlo_img_{$img.id_header_image|intval}"
	...
	data-titles="{$img.titles_json|escape:'htmlall':'UTF-8'}"
	data-descriptions="{$img.descriptions_json|escape:'htmlall':'UTF-8'}"
	data-description-color="{$img.description_color|default:'#ffffff'|escape:'htmlall':'UTF-8'}"
	data-description-font-size="{$img.description_font_size|default:16|intval}"
	data-description-font-weight="{$img.description_font_weight|default:'400'|escape:'htmlall':'UTF-8'}">
	...
	<td class="qlo-img-title-cell">
		{if $img.title}{$img.title|truncate:50:'...'|escape:'html':'UTF-8'}{else}&mdash;{/if}
	</td>
	<td class="qlo-img-description-cell">
		{if $img.description}{$img.description|truncate:50:'...'|escape:'html':'UTF-8'}{else}&mdash;{/if}
	</td>
