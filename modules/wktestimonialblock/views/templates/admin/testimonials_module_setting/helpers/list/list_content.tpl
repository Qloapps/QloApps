			...
			{block name="td_content"}
				...
				{if isset($tr.$key)}
					...
					{elseif isset($params.activeVisu)}
						{if $tr.$key}
							<i class="icon-check-ok"></i> {l s='Enabled' mod='wktestimonialblock'}
						{else}
							<i class="icon-remove"></i> {l s='Disabled' mod='wktestimonialblock'}
						{/if}
					...
					{elseif isset($params.image)}
						...
						{foreach $tr as $t}
							{if $k==0}
								{assign var="imagepath" value="$ps_testimonials_img_dir/$t.jpg"}
								{if file_exists($imagepath)}
									<img width="60px" alt="{l s='Person image' mod='wktestimonialblock'}" src="{$testimonials_img_dir}/{$t}.jpg">
								{else}
									<img width="60px" alt="{l s='Default Logo' mod='wktestimonialblock'}" src="{$testimonials_img_dir}/default.jpg">
								{/if}
							{/if}
					...
					{elseif isset($params.type) && $params.type == 'percent'}
						{$tr.$key} {l s='%' mod='wktestimonialblock'}
	...
	<tr>
		<td class="list-empty" colspan="{count($fields_display)}">
			<div class="list-empty-msg">
				...
				{l s='No records found' mod='wktestimonialblock'}
			</div>
		</td>
	</tr>
{/if}
