...
class BankwireValidationModuleFrontController extends ModuleFrontController
{
	...
	public function postProcess()
	{
		...
		$this->module->validateOrder($cart->id, Configuration::get('PS_OS_AWATING'), $total, $this->module->displayName, NULL, $mailVars, (int)$currency->id, false, $customer->secure_key);
