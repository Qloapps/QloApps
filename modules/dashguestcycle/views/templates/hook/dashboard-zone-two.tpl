    ...
    <section id="dashguestcycle" class="panel widget allow_push">
        ...
        <section>
            <ul class="nav nav-tabs">
                ...
                <li>
                    <a href="#dgc_current_no_show" data-toggle="tab">
                        <span>{l s='No Show' mod='dashguestcycle'}</span>
                        <span class="label label-info" id="dgc_count_no_show">0</span>
                    </a>
                </li>
            ...
            <div class="tab-content panel panel-sm">
                ...
                <div class="tab-pane" id="dgc_current_no_show">
                    <table class="table table-striped" id="dgc_table_no_show">
                        <thead></thead>
                        <tbody></tbody>
                    </table>
                </div>
