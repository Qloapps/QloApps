...
{
    $objUpgrade = new UpgradeBlockCurrencies110($module);
    return $objUpgrade->initUpgrade();
}

class UpgradeBlockCurrencies110
{
    ...
    {
        if (!$this->module->unregisterHook('displayFooterMostLeftBlock')
            || !$this->module->unregisterHook('displayHeader')
