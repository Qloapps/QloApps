...
<form method="POST" id="search_hotel_block_form" class="grid">
    {block name='search-form-location-search-field'}
        ...
        {/if}
    {/block}
    {block name='search-form-hotel-search-field'}
    ...
    {block name='search-form-dates-search-field'}
    ...
    {block name='search-form-occupancy-search-field'}
