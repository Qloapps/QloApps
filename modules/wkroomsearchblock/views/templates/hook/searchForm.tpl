...
{block name='search_form_content'}
    <form method="POST" id="search_hotel_block_form" class="grid">
        {block name='search_form_location_field'}
            ...
            {/if}
        {/block}
        {block name='search_form_hotel_field'}
            ...
            {/if}
        {/block}
        {block name='search_from_date_field'}
        ...
        {block name='search_form_occupancy_field'}
            {if isset($is_occupancy_wise_search) && $is_occupancy_wise_search}
                <div class="form-group area-{$column_widths['occupancy']}">
                    <div class="dropdown">
                        ...
                        {block name='search_form_occupancy_field_wrapper'}
                            <div id="search_occupancy_wrapper" class="dropdown-menu">
                                ...
                                {block name='search_form_occupancy_actions'}
