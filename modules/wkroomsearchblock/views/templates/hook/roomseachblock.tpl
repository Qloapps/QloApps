          ...
          <div class="row">
            <div class="col-xs-6 col-md-6 col-sm-12">
              ...
              <div class="input-group">
                <input class="form-control {if isset($error) && $error == 2}error_border{/if}" type="text" id="check_in_time" name="check_in_time" autocomplete="off"/>
                <label class="input-group-addon calender-icon-cont" for="check_in_time"><i class="icon-calendar"></i></label>
              </div>
              <p class="error_msg" id="check_in_time_error_p">{if isset($error) && $error == 2}{l s='Check In date is required.' mod='wkroomsearchblock'}{/if}</p>
            </div>
            <div class="col-xs-6 col-md-6 col-sm-12">
