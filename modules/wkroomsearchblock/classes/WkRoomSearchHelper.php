...
class WkRoomSearchHelper
{
    ...
    public function assignSearchPanelVariables()
    {
        ...
        foreach ($hotelsInfo as &$hotel) {
            ...
            $hotel['preperation_time'] = HotelOrderRestrictDate::getPreperationTime($hotel['id']);
        }
        ...
        $smartyVars['preperation_time'] = HotelOrderRestrictDate::getPreperationTime($idHotel);
