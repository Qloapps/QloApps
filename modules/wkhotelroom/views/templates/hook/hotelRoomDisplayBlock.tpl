        ...
        <div id="hotelRoomsBlock" class="row home_block_container">
            <div class="col-xs-12 col-sm-12">
                {block name='hotel_room_display_header'}
                    ...
                    {/if}
                {/block}
                {block name='hotel_room_display_body'}
                            ...
                            {foreach from=$hotelRoomDisplay item=roomDisplay name=htlRoom}
                                ...
                                {/if}
                                        <div class="col-sm-12 col-md-6 margin-btm-30">
                                            ...
                                            {block name='display_hotel_rooms_block_image_after'}
                                            ...
                                            <div class="hotelRoomDescContainer">
                                                ...
                                                <div class="row margin-lr-0 htlRoomTypeDescText">{$roomDisplay.description}</div>
                                                <div class="row margin-lr-0">
