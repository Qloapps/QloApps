...
class WkHotelRoomDisplay extends ObjectModel
{
    ...
    public static function insertModuleDemoData()
    {
        ...
        foreach ($languages as $lang) {
            ...
            $HOTEL_ROOM_DISPLAY_DESCRIPTION[$lang['id_lang']] = 'Families travelling with kids will find Amboseli
            national park a safari destination matched to no other, with less tourist traffic, breathtaking open
            space.';
        }
