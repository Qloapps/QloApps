	...
	<section id="dashtrends" class="panel widget{if $allow_push} allow_push{/if}">
		...
		<div class="row">
			<div id="dashtrends_toolbar">
				...
				data-toggle="tooltip" data-original-title="{l s='Total number of booking received within the date range that are considered validated.' mod='dashtrends'}" data-placement="bottom" style='background-color: #56CE56;'>
						<dt>{l s='Booking' mod='dashtrends'}</dt>
				...
				data-toggle="tooltip" data-original-title="{l s='Average Cart Value is a metric representing the value of an average order within the date range. It is calculated by dividing Sales by booking.' mod='dashtrends'}" data-placement="bottom" style='background-color: #FF4036;'>
				...
				data-toggle="tooltip" data-original-title="{l s='Total number of visits within the date range. A visit is the period of time a user is actively engaged with your website.' mod='dashtrends'}" data-placement="bottom" style='background-color: #FF7F0E;'>
				...
				data-toggle="tooltip" data-original-title="{l s='Hotel industry Conversion Rate is the percentage of visits that resulted in an validated booking.' mod='dashtrends'}" data-placement="bottom" style="background-color: #A569DF;">
				...
				data-toggle="tooltip" data-original-title="{l s='Net profit is a measure of the profitability of a venture after accounting for all the Hotel industry costs. You can provide these costs by clicking on the configuration icon right above here.' mod='dashtrends'}"
