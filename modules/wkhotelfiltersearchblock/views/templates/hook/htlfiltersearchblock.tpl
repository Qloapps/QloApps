    ...
    <div class="col-sm-12 category_page_search_block clear-both">
        <form method="POST" autocomplete="on" autofill="on">
            ...
            {if isset($error) && ($error == 1)}
                <p class="error_msg"><i class="icon-times-circle-o"></i>&nbsp;&nbsp;{l s='All Fields are mandatory.' mod='wkhotelfiltersearchblock'}</p>
            {/if}
            {if isset($location_enable) && $location_enable}
                <div class="form-group hotel_location_div">
                    <label class="control-label" for="">{l s='Hotel Location' mod='wkhotelfiltersearchblock'}</label>
                    <input class="form-control" placeholder="{l s='Enter a city, state, country name' mod='wkhotelfiltersearchblock'}" type="text" id="hotel_location" name="hotel_location" autocomplete="off" {if isset($search_data)}value="{$search_data['location']}" city_cat_id="{$search_data['parent_data']['id_category']}"{/if}/>
                    <div class="dropdown">
            ...
            <div class="form-group htl_nm_cont {if $totalActiveHotels <= 1 && !$show_only_active_htl}hidden{/if}">
                <label class="control-label" for="">{l s='Hotel Name' mod='wkhotelfiltersearchblock'}</label>
                {if isset($all_hotels_info) && $totalActiveHotels}
                    <div class="dropdown">
                        <button class="btn btn-default hotel_cat_id_btn dropdown-toggle" type="button" data-toggle="dropdown">
                            ...
                            {else}
                                <span id="hotel_cat_name" class="pull-left">{l s='Select Hotel' mod='wkhotelfiltersearchblock'}</span>
                            {/if}
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-xs-12 col-sm-12">
                        <label class="control-label" for="check_in_time">{l s='Check In Time' mod='wkhotelfiltersearchblock'}</label>
                    ...
                    <div class="col-xs-12 col-sm-12 margin-top-10">
                        <label class="control-label" for="check_out_time">{l s='Check Out Time' mod='wkhotelfiltersearchblock'}</label>
                        <div class="input-group">
...
{strip}
    {addJsDefL name=no_results_found_cond}{l s='No results found for this search' js=1 mod='wkhotelfiltersearchblock'}{/addJsDefL}
    {addJsDefL name=hotel_loc_cond}{l s='Please enter a hotel location' js=1 mod='wkhotelfiltersearchblock'}{/addJsDefL}
    {addJsDefL name=hotel_name_cond}{l s='Please select a hotel name' js=1 mod='wkhotelfiltersearchblock'}{/addJsDefL}
    {addJsDefL name=check_in_time_cond}{l s='Please enter Check In time' js=1 mod='wkhotelfiltersearchblock'}{/addJsDefL}
    {addJsDefL name=check_out_time_cond}{l s='Please enter Check Out time' js=1 mod='wkhotelfiltersearchblock'}{/addJsDefL}
    {addJsDefL name=num_adults_cond}{l s='Please enter number of adults.' js=1 mod='wkhotelfiltersearchblock'}{/addJsDefL}
    {addJsDefL name=num_children_cond}{l s='Please enter number of children.' js=1 mod='wkhotelfiltersearchblock'}{/addJsDefL}
    {addJsDefL name=some_error_occur_cond}{l s='Some error occured. Please try again.' js=1 mod='wkhotelfiltersearchblock'}{/addJsDefL}
    {addJsDefL name=less_checkin_date}{l s='Check In date can not be before current date.' js=1 mod='wkhotelfiltersearchblock'}{/addJsDefL}
    {addJsDefL name=more_checkout_date}{l s='Check Out date must be greater than Check In date.' js=1 mod='wkhotelfiltersearchblock'}{/addJsDefL}
