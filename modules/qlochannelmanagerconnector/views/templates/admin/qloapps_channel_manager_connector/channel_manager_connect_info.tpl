                ...
                <div class="row flex-display">
                    ...
                    <div class="col-md-10 qcm_info_wrapper">
                        ...
                        <div class="qcm_info_block_content">
                            ...
                            <br>
                            {l s='QloApps channel manager synchronizes inventory, rates, restrictions with all connected OTA channels and automated bookings sync connected OTAs and QloApps PMS. QloApps PMS.' mod='qlochannelmanagerconnector'}
                        </div>
        ...
        <div class="col-md-6 qcm_block_wrapper padding-left-10 flex-display">
            <div class="qcm_info_block">
                <div class="row flex-display">
                    ...
                    <div class="col-md-10 qcm_info_wrapper">
                        <div class="qcm_info_block_head">
                            {l s='How PMS connects with channel manager?' mod='qlochannelmanagerconnector'}
                        </div>
                        <div class="qcm_info_block_content">
                            {l s='You can connect QloApps PMS with channel manager through few simple steps' mod='qlochannelmanagerconnector'} :
                            <ul>
                                <li>{l s='Enable webservice and all the APIs from QloApps back-office.' mod='qlochannelmanagerconnector'}</li>
                                <li>{l s='Enter QloApps webservice credentials under PMS settings of channel manager .' mod='qlochannelmanagerconnector'}</li>
