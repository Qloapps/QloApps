...
return array(
	...
	'translations' => array(
		...
		'The required PHP version is between 8.1 to 8.4' => 'The required PHP version is between 8.1 to 8.4',
		...
		'You are using PHP %s version. Soon, the latest PHP version supported by QloApps will be PHP 8.1. To make sure you’re ready for the future, we recommend you to upgrade to PHP 8.1 now!' => 'You are using PHP %s version. Soon, the latest PHP version supported by QloApps will be PHP 8.1. To make sure you’re ready for the future, we recommend you to upgrade to PHP 8.1 now!',
