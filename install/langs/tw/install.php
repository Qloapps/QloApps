...
return array(
    ...
    'translations' => array(
        ...
        'To enjoy the many features that are offered for free by QloApps, please read the license terms below. PrestaShop core is licensed under OSL 3.0, while the modules and themes are licensed under AFL 3.0.' => '要自由使用 PrestaShop 的許多功能，請先詳閱下面的授權條款。PrestaShop 程式碼是以 OSL 3.0 發布，模組與佈景則是 AFL 3.0 。',
