...
",
		...
		$('#customer_part').on('click','button.setup-customer',function(e){
			e.preventDefault();
			<?php $_smarty_tpl->tpl_vars['cart'] = new Smarty_variable($_smarty_tpl->tpl_vars['htl_cart']->value, null, 0);?>//setting cart as we sent from adminOrderController
			id_cart = <?php echo intval($_smarty_tpl->tpl_vars['htl_cart']->value->id);?>
...
",
			...
			success : function(res)
			{
				if(res.found)
				{
					var cart_id = "<?php echo $_smarty_tpl->tpl_vars['cart_id']->value;?>
";
					var html = '';
...
&id_customer='+this.id_customer+'&viewcustomer&liteDisplaying=1" class="btn btn-default fancybox"><i class="icon-search"></i> <?php echo smartyTranslate(array('s'=>'Details'),$_smarty_tpl);?>
						...
						html += '<button type="button" data-id_cart="'+cart_id+'" data-customer="'+this.id_customer+'" class="setup-customer btn btn-default pull-right"><i class="icon-arrow-right"></i> <?php echo smartyTranslate(array('s'=>'Choose'),$_smarty_tpl);?>
</button>';
						html += '</div>';
						html += '</div>';
						html += '</div>';
...
" title="Room image" /></td>
								...
								<td><?php echo $_smarty_tpl->tpl_vars['data']->value['date_from'];?>
&nbsp To&nbsp <?php echo $_smarty_tpl->tpl_vars['data']->value['date_to'];?>
</td>
								<td><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['data']->value['amt_with_qty']),$_smarty_tpl);?>
</td>
...
=1" method="post" autocomplete="off" style="display:none" id="cart_detail_form">
	<div class="panel" id="products_part" style="display:none;">
		...
		<div class="form-group">
			<input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['cart_id']->value;?>
