<?php /* Smarty version Smarty-3.1.19, created on 2016-01-07 10:53:33
         compiled from "/home/sumit/public_html/html/hotel-reservation-system/modules/wkroomsearchblock/views/templates/hook/roomseachblock.tpl" */ ?>
<?php /*%%SmartyHeaderCode:424362026568d37ad074e37-93027785%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd3c771bfb6470381f780de6ded8650fb8b9eaa85' => 
    array (
      0 => '/home/sumit/public_html/html/hotel-reservation-system/modules/wkroomsearchblock/views/templates/hook/roomseachblock.tpl',
      1 => 1452142877,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '424362026568d37ad074e37-93027785',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_568d37ad0f4461_71733092',
  'variables' => 
  array (
    'is_index_page' => 0,
...
<?php if ($_valid && !is_callable('content_568d37ad0f4461_71733092')) {function content_568d37ad0f4461_71733092($_smarty_tpl) {?><?php if (isset($_smarty_tpl->tpl_vars['is_index_page']->value)&&$_smarty_tpl->tpl_vars['is_index_page']->value) {?>
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-md-6 col-sm-12">
                                ...
                                <div class="input-group">
                                    <input class="form-control <?php if (isset($_smarty_tpl->tpl_vars['error']->value)&&($_smarty_tpl->tpl_vars['error']->value==2||$_smarty_tpl->tpl_vars['error']->value==5)) {?>error_border<?php }?>" type="text" id="check_in_time" name="check_in_time" autocomplete="off"/>
                                ...
                                <p class="error_msg" id="check_in_time_error_p">
                                    <?php if (isset($_smarty_tpl->tpl_vars['error']->value)) {?>
                                        <?php if (($_smarty_tpl->tpl_vars['error']->value==2)) {?>
                                            <?php echo smartyTranslate(array('s'=>'Check In date is required.','mod'=>'wkroomsearchblock'),$_smarty_tpl);?>

                                        <?php } elseif (($_smarty_tpl->tpl_vars['error']->value==5)) {?>
                                            <?php echo smartyTranslate(array('s'=>'check In date can not be before todays date.','mod'=>'wkroomsearchblock'),$_smarty_tpl);?>
