<?php /* Smarty version Smarty-3.1.19, created on 2015-11-03 09:00:30
         compiled from "/home/sumit/public_html/html/ps-hotel-reservation-system/modules/wkhotelfilterblock/views/templates/hook/htlfilterblock.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17735815245638bdfe164781-03681800%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c8e5eabd9a1daa9a88f8285228cfbea703fe80a4' => 
    array (
      0 => '/home/sumit/public_html/html/ps-hotel-reservation-system/modules/wkhotelfilterblock/views/templates/hook/htlfilterblock.tpl',
      1 => 1446483103,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17735815245638bdfe164781-03681800',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5638bdfe1ddc27_96309750',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5638bdfe1ddc27_96309750')) {function content_5638bdfe1ddc27_96309750($_smarty_tpl) {?><div id="filter_results" class="row block">
	<div class="col-sm-12">
		<?php if (isset($_smarty_tpl->tpl_vars['config']->value)&&$_smarty_tpl->tpl_vars['config']->value['SHOW_RATTING_FILTER']) {?>
			<div class="row margin-lr-0 layered_filter_cont">
				<div class="col-sm-12 layered_filter_heading">
					<span><?php echo smartyTranslate(array('s'=>'Guest Ratting','mod'=>'wkhotelfilterblock'),$_smarty_tpl);?>
</span>
				...
				<div class="col-sm-12 lf_sub_cont">
					...
					<div class="layered_filt">
						...
						<span class="filters_name"><?php echo smartyTranslate(array('s'=>'No Ratting','mod'=>'wkhotelfilterblock'),$_smarty_tpl);?>
</span>
					</div>
				</div>
			</div>
