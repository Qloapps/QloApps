<?php /* Smarty version Smarty-3.1.19, created on 2015-11-02 11:06:30
         compiled from "/home/sumit/public_html/html/ps-hotel-reservation-system/themes/hotel-reservation-theme/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:156972728856378a06792d47-36633444%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '19637a1f5cdebf7e0031d37bf83ef4039bf5dca1' => 
    array (
      0 => '/home/sumit/public_html/html/ps-hotel-reservation-system/themes/hotel-reservation-theme/product.tpl',
      1 => 1446454876,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '156972728856378a06792d47-36633444',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56378a06ed8f08_56909345',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56378a06ed8f08_56909345')) {function content_56378a06ed8f08_56909345($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include '/home/sumit/public_html/html/ps-hotel-reservation-system/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/home/sumit/public_html/html/ps-hotel-reservation-system/tools/smarty/plugins/function.counter.php';
if (!is_callable('smarty_modifier_date_format')) include '/home/sumit/public_html/html/ps-hotel-reservation-system/tools/smarty/plugins/modifier.date_format.php';
?>
...
"<?php }?>/>
	        ...
	        <div class="col-sm-2">
	          <button type="submit" class="btn btn-default button button-medium pull-right" name="product_page_search_submit" id="search_room_submit"><?php echo smartyTranslate(array('s'=>'Search Now','mod'=>'wkroomsearchblock'),$_smarty_tpl);?>
</button>
	        </div>
	      </form>
		</div>
		...
		<div class="pb-left-column col-xs-12 col-sm-4 col-md-8" style="border:1px solid #cccccc">
			<div class="room_hotel_name_block">
				<div class="hotel_name_block">
					<span><?php echo $_smarty_tpl->tpl_vars['hotel_name']->value;?>
</span>
				</div>
...
?>
									<img height="30px" width="30px" src="<?php echo $_smarty_tpl->tpl_vars['ftr_img_src']->value;?>
			...
			<div class="booking-form">
				<div class="total_booking_price_block">
					<p class="booking_total_price">
						<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>floatval($_smarty_tpl->tpl_vars['product']->value->price)),$_smarty_tpl);?>
...
.product_description_tabs li.selected
{
	font-family: inherit;
    color: #404040;
    font-size: 18px;
...
.product_description_tabs li.active
{
	font-family: inherit;
    color: #404040;
    font-size: 18px;
...
.room_unavailability_qty_error_div
{
	display: none;
...
.room_unavailability_date_error_div
{
	display: none;
	background-color: #cd5d5d;
    color: #ffffff;
...
.product_page_search .location_search_results_ul
{
	width: 90%!important;
}

.product_page_search .location_search_results_ul li
{
	border-top: 1px solid #cccccc;
}

.product_page_search #search_room_submit
{
	margin-top: 23px;
    padding: 9.2px 40px!important;
}
...
.search_block_container.product_page_search
{
	margin-top: 0px;
}
...
$(document).ready(function()
{
	...
	$('#quantity_wanted').on('keyup', function()
	{
    	...
    	if(parseInt(qty_wntd) < 1 || parseInt(qty_wntd) > $('#max_avail_type_qty').val())
    	{
    		...
    		/*$('.room_unavailability_qty_error_div').text(wrong_qty_cond);
