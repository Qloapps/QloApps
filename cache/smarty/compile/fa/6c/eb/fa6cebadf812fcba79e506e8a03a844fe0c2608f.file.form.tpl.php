<?php /* Smarty version Smarty-3.1.19, created on 2015-11-02 11:04:26
         compiled from "/home/sumit/public_html/html/ps-hotel-reservation-system/modules/hotelreservationsystem/views/templates/admin/add_hotel/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8102684855637898aa7b700-60574742%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fa6cebadf812fcba79e506e8a03a844fe0c2608f' => 
    array (
      0 => '/home/sumit/public_html/html/ps-hotel-reservation-system/modules/hotelreservationsystem/views/templates/admin/add_hotel/helpers/form/form.tpl',
      1 => 1446460206,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8102684855637898aa7b700-60574742',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5637898ac1ecb1_55225846',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5637898ac1ecb1_55225846')) {function content_5637898ac1ecb1_55225846($_smarty_tpl) {?><div class="panel">
...
" <?php if (isset($_smarty_tpl->tpl_vars['edit']->value)) {?> <?php if ($_smarty_tpl->tpl_vars['hotel_info']->value['country_id']==((string)$_smarty_tpl->tpl_vars['countr']->value['id_country'])) {?>selected<?php }?><?php }?>> <?php echo $_smarty_tpl->tpl_vars['countr']->value['name'];?>
		...
		<div class="form-group">
			<label class="control-label col-sm-3 required" for="hotel_state"><?php echo smartyTranslate(array('s'=>'State :','mod'=>'hotelreservationsystem'),$_smarty_tpl);?>
</label>
			<div class="col-sm-6">
				<div style="width: 195px;">
...
" <?php if (isset($_smarty_tpl->tpl_vars['edit']->value)) {?> <?php if ($_smarty_tpl->tpl_vars['hotel_info']->value['state_id']==((string)$_smarty_tpl->tpl_vars['state']->value['id'])) {?>selected<?php }?><?php }?>> <?php echo $_smarty_tpl->tpl_vars['state']->value['name'];?>
				...
				<span class="country_import_note" style='font-style:italic; color:FCF8E3;'><?php echo smartyTranslate(array('s'=>'Please import selected country in you prestashop for its states.','js'=>1,'mod'=>'hotelreservationsystem'),$_smarty_tpl);?>
</span>
			</div>	
		</div>
		<div class="form-group">
