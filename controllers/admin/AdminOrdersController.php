    ...
    public function renderView()
    {
        ...
        if ($order_detail_data = $objBookingDetail->getOrderFormatedBookinInfoByIdOrder($order->id)) {
            ...
            foreach ($order_detail_data as $key => $value) {
                ...
                $order_detail_data[$key]['connected_rooms'] = array();
                if (class_exists('HotelRoomConnected')) {
                    $order_detail_data[$key]['connected_rooms'] = HotelRoomConnected::getConnectedRoomsByHotel(
                        (int) $value['id_hotel'],
