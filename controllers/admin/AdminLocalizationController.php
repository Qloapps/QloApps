        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'desc'     => $this->l('If set to yes then the localization pack will be downloaded from QloApps API. Otherwise the local xml file found in the localization folder of your QloApps installation will be used.'),
