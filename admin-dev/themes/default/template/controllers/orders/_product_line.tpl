            ...
            <div class="btn-group pull-right">
                ...
                {else}
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        {if isset($use_tourism_tax) && $use_tourism_tax && isset($data.tourism_tax_status) && $data.tourism_tax_status != $tourism_tax_status_not_applicable && $data.id_status != $ROOM_STATUS_CANCELLED && !$data.is_refunded}
