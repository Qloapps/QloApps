        ...
        <td width="50%" class="left" valign="top">
            <table class="bordered-table" width="100%" cellpadding="5" cellspacing="0">
                <tbody>
                    ...
                    {if (!isset($footer.show_tourism_tax_separately) || $footer.show_tourism_tax_separately) && isset($footer.total_tourism_tax) && $footer.total_tourism_tax > 0}
                    ...
                    {else}
                        {if ($footer.total_tax_without_discount + $footer.total_tourism_tax) > 0}
                            <tr>
                                <td class="grey small bold" width="70%">{l s='Total Taxes' pdf='true'}</td>
                                <td class="white right small bold" width="30%">{displayPrice currency=$order->id_currency price=($footer.total_tax_without_discount + $footer.total_tourism_tax)}</td>
                            </tr>
                        {/if}
                    {/if}
