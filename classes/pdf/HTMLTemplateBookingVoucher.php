...
class HTMLTemplateBookingVoucherCore extends HTMLTemplate
{
    ...
    public function getContent()
    {
        ...
        if (!empty($idsOrderDetail)) {
            ...
            $serviceProductsCostTaxIncl = $this->order->getTotalProductsWithTaxes(false, false, Product::SELLING_PREFERENCE_WITH_STANDALONE, false, false, $idsOrderDetail) + $this->order->getTotalProductsWithTaxes(false, false, Product::SELLING_PREFERENCE_WITH_HOTEL, false, false, $idsOrderDetail);
