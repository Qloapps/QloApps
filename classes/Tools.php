...
class ToolsCore
{
    ...
    */
    ...
    public static function generateHtaccess($path = null, $rewrite_settings = null, $cache_control = null, $specific = '', $disable_multiviews = null, $medias = false, $disable_modsec = null)
    {
        ...
        fwrite($write_fd, "# ~~start~~ Do not remove this comment, QloApps will keep automatically the code outside this comment when .htaccess will be generated again\n");
        fwrite($write_fd, "# .htaccess automaticaly generated by QloApps hotel commerce open-source solution\n");
        fwrite($write_fd, "# https://www.qloapps.com\n\n");
...
<IfModule mod_deflate.c>
	<IfModule mod_filter.c>
        ...
        fwrite($write_fd, "# ~~end~~ Do not remove this comment, QloApps will keep automatically the code outside this comment when .htaccess will be generated again");
        if ($specific_after) {
            fwrite($write_fd, "\n\n".trim($specific_after));
        }
        fclose($write_fd);
